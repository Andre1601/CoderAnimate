...
function UploadImage() {
    return (
        <label id="image_input" className="flex flex-col border-solid border-2 justify-center items-center border-[#7868E6] rounded-lg mt-6 h-[260px] sm:h-80 lg:h-[500px] cursor-pointer">
